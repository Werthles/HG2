...
tooltip = "Hired Guns 2 Host Mod"; //word when mod icon hovered over
name = "Hired Guns 2 Host Mod"; // name in expansions
picture = "\Werthles_HG2Images\iconHG2Expansions.paa"; // picture in expansions
overview = "Hired Guns 2 Mod<br/><br/>This is the mod required by hosts of 'Hired Guns 2'.<br/><br/Client players do not need to run this as all progress is saved to the host's machine."; //description in expansion menu
...
tooltipOwned = "Hired Guns 2 Host Mod";
